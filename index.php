...
<body>
  <header>
    ...
    <div class="menu">
      ...
      <a href="#"></a>
      <a href="#"></a>
      <a href="testlogin.php">Register</a>
    </div>
  </header>
...
<script type="text/javascript">
  $(document).on('click','#register',function() {
    ...
    if(username =='' || nama=='' || email == '' || password == '' || level == '') {
      $("#result").html("<div class='alert alert-error'>Masih Ada Data Yang Kosong !</div>");
      return false;
    }
    ...
    $.ajax({
      ...
      success:function(data) {
        ...
        $("#result").html("<center>Sedang Proses....</center>");
      },error:function() {
        $("#result").html("<center>Terjadi Kesalahan....</center>");
      }
    });
  });
  ...
  $(document).on('click','#login',function() {
    ...
    $.ajax({
      ...
      success:function(data) {
        if(data=="staff") {
          pageRedirect("staff.php")
        } else if(data== "applicant") {
          pageRedirect("applicant.php")
        } else {
